...
fingerUp = read_file('../DataSet2/up.csv')
# finger down data frame
fingerDown = read_file('../DataSet2/down.csv')
# finger left data frame
fingerLeft = read_file('../DataSet2/left.csv')
# finger right data frame
fingerRight = read_file('../DataSet2/right.csv')
# 90 deg clock data frame
fingerClock = read_file('../DataSet2/clock.csv')
# 90 deg counter data frame
fingerCounter = read_file('../DataSet2/counter.csv')
...
# store into file
df_to_csv(f_df, "../DataSet2/extracted_features.csv")
