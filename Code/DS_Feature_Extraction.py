def feature_extraction(data_frame, test_type):
    ...
    def standard_deviation(data_group):
        ...
        std_df_3 = std_df_2.set_axis(
            ['GYRO-X-STD-Ring1', 'GYRO-Y-STD-Ring1', 'GYRO-Z-STD-Ring1', 'GYRO-X-STD-Ring2', 'GYRO-Y-STD-Ring2',
             'GYRO-Z-STD-Ring2', 'GYRO-X-STD-Ring3', 'GYRO-Y-STD-Ring3', 'GYRO-Z-STD-Ring3'],
            axis=1, inplace=False)
        return std_df_3
    ...
    def standard_deviation_df():
        ...
        for group in range(grouped.ngroups - 1):
            std_df = std_df.append(standard_deviation(grouped.get_group(group + 2).drop(columns="TEST")),
                                   ignore_index=True)
    ...
    def variance(data_group):
        ...
        var_df_3 = var_df_2.set_axis(
            ['GYRO-X-VAR-Ring1', 'GYRO-Y-VAR-Ring1', 'GYRO-Z-VAR-Ring1', 'GYRO-X-VAR-Ring2', 'GYRO-Y-VAR-Ring2',
             'GYRO-Z-VAR-Ring2', 'GYRO-X-VAR-Ring3', 'GYRO-Y-VAR-Ring3', 'GYRO-Z-VAR-Ring3'],
            axis=1, inplace=False)
        return var_df_3
    ...
    def skewness(data_group):
        ...
        skew_df_3 = skew_df_2.set_axis(
            ['GYRO-X-SKEW-Ring1', 'GYRO-Y-SKEW-Ring1', 'GYRO-Z-SKEW-Ring1', 'GYRO-X-SKEW-Ring2', 'GYRO-Y-SKEW-Ring2',
             'GYRO-Z-SKEW-Ring2', 'GYRO-X-SKEW-Ring3', 'GYRO-Y-SKEW-Ring3', 'GYRO-Z-SKEW-Ring3'],
            axis=1, inplace=False)
        return skew_df_3
    ...
    def kurtosis(data_group):
        ...
        kurt_df_3 = kurt_df_2.set_axis(
            ['GYRO-X-KURT-Ring1', 'GYRO-Y-KURT-Ring1', 'GYRO-Z-KURT-Ring1', 'GYRO-X-KURT-Ring2', 'GYRO-Y-KURT-Ring2',
             'GYRO-Z-KURT-Ring2', 'GYRO-X-KURT-Ring3', 'GYRO-Y-KURT-Ring3', 'GYRO-Z-KURT-Ring3'],
            axis=1, inplace=False)
        return kurt_df_3
    ...
    c_df = standard_deviation_df().join(variance_df()).join(skewness_df()).join(kurtosis_df())
